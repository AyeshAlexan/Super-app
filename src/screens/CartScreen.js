              ...
              <View style={styles.itemDetails}>
                <View style={styles.itemHeader}>
                  ...
                  <TouchableOpacity onPress={() => removeFromCart(item.id)}>
                    <Icon name="trash-can-outline" size={22} color="#D1D5DB" />
                  </TouchableOpacity>
                </View>
                ...
                <View style={styles.priceRow}> 
                  ...
                  <View style={styles.quantityControls}>
                    ...
                    <TouchableOpacity onPress={() => updateQuantity(item.id, 1)} style={styles.qtyBtnActive}>
...
const styles = StyleSheet.create({
  ...
  itemsList: { gap: 12 },
  cartCard: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 20, padding: 12, elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5 },
  itemImage: { width: 75, height: 75, borderRadius: 15 },
  itemDetails: { flex: 1, marginLeft: 12 },
  itemHeader: { flexDirection: 'row', justifyContent: 'space-between' },
  itemName: { fontWeight: 'bold', fontSize: 16, color: '#1f2937' },
  itemUnit: { fontSize: 12, color: '#9ca3af', marginBottom: 5 },
  ...
  qtyBtn: { backgroundColor: '#f3f4f6', padding: 4, borderRadius: 8 },
  qtyBtnActive: { backgroundColor: '#16a34a', padding: 4, borderRadius: 8 },
  ...
  addressCard: { backgroundColor: '#fff', marginTop: 15, borderRadius: 15, padding: 15, elevation: 1 },
  ...
  summaryCard: { backgroundColor: '#fff', marginTop: 15, borderRadius: 25, padding: 20, elevation: 4, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10 },
  summaryTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 15, color: '#1f2937' },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
  summaryLabel: { color: '#6b7280', fontSize: 15 },
  summaryValue: { fontWeight: '600', color: '#1f2937', fontSize: 15 },
